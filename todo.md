...
# Better Exports (Planned Release: 0.4.0)
...
# Better Exports v2 (Planned Release: 0.5.0)
...
- New Button to directly open the generated diff in Text Editor after generation

# Settings-Section (Planned Release: 0.6.0)
...
# Better Section Management (Planned Release: 0.7.0)
